...
[CustomEditor(typeof(portal_script)), CanEditMultipleObjects]//to select componet ,and select more 
public class PortalEditor : Editor//for change portal_component
{
